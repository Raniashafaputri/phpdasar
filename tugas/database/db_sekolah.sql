...
CREATE TABLE ` alokasi_mapel` (
  ...
  CONSTRAINT ` alokasi_mapel_ibfk_1` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id`),
  CONSTRAINT ` alokasi_mapel_ibfk_2` FOREIGN KEY (`id_mapel`) REFERENCES `mapel` (`id`)
...
(1,'raniasafa303@gmail.com','rania','1234567'),
(2,'raniasafa303@gmail.com','rania','1234567'),
(3,'raniasafa303@gmail.com','rania','1234567');
...
CREATE TABLE `kelas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tingkat_keas` varchar(255) NOT NULL,
